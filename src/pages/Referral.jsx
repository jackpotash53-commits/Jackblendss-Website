          ...
          {STEPS.map((step) => (
            ...
            >
              ...
              <div>
                ...
                <div className="text-[14px] text-black/45 leading-[1.6]" dangerouslySetInnerHTML={{ __html: step.desc.replace(/\$10 off your next cut/g, '<strong>$10 off your next cut</strong>').replace(/your next cut is free/g, '<strong>your next cut is free</strong>') }} />
              </div>
            </div>
          ))}
        </div>
